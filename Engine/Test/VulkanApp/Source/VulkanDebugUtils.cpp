...
namespace Cosmic::Utils
{
	...
	ELogSeverity VkDebugUtilsMessageSeverityFlagBitsEXTToELogSeverity(VkDebugUtilsMessageSeverityFlagBitsEXT severity)
	{
		switch (severity)
		{
	...
	const char* VkDebugUtilsMessageTypeFlagsEXTToString(VkDebugUtilsMessageTypeFlagsEXT type)
	{
		switch (type)
		{
...
{
	auto pfn = (PFN_vkDestroyDebugUtilsMessengerEXT)vkGetInstanceProcAddr(instance, "vkDestroyDebugUtilsMessengerEXT");
...
{
	Cosmic::Log::Error("Vulkan Error ({}) (file: {}, line: {}, function: {})", file, line, function);
