...
namespace Cosmic
{
    ...
    Ref<VertexBuffer> CreateVertexBuffer(void* vertices, uint32 size, EBufferUsage usage = EBufferUsage::Static);
    Ref<IndexBuffer>  CreateIndexBuffer(uint32* indices, uint32 count, EBufferUsage usage = EBufferUsage::Static);
